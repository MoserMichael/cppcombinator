...
inline Char_checker_result pparse_pascal_identifier(Char_t current_char, bool iseof, Char_t *matched_so_far) {
...
inline Char_checker_result pparse_pascal_string(Char_t current_char, bool iseof, Char_t *matched_so_far) {
